...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
               ...
               <?php if ( has_post_thumbnail() && !is_search() ) { ?>
				<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( esc_html__( 'Permalink to %s', 'notepad' ), the_title_attribute( 'echo=0' ) ) ); ?>">
		...
		<?php }
			...
			<div class="entry-content">
				<?php the_content( wp_kses( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'notepad' ), array( 'span' => array( 
					'class' => array() ) ) )
					); ?>

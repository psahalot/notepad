 ...
 * Notepad Theme.
 * 
 * This file has been included from the Genesis Framework by StudioPress.
 *
...
/**
 * Notepad User Profile widget class.
 *
 * @since 1.0
 *
...
class stream_User_Profile_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'user-profile', __( 'Notepad - User Profile', 'genesis' ), $widget_ops, $control_ops );
